...
* **R38** · **Erreur de pseudonyme lors d'un achat ?** L'administration restaure l'achat sur le bon pseudonyme, contre preuve d'achat de moins de 48 heures.
* **R39** · **Mineur ?** L'autorisation de ton tuteur légal est requise avant tout achat.

<p align="center"><img src=".gitbook/assets/sep-dynastia.png" alt=""></p>

<h2 align="center"><mark style="color:yellow;">9. Compensations et transferts de compte</mark></h2>

* **R40** · **Les pertes en jeu** ne sont compensées qu'en cas de bug imputable au serveur, via ticket ; dans tous les autres cas, la protection de tes biens t'incombe.
* **R41** · **Transferts de compte** : l'administration peut migrer les données d'un compte vers un autre **uniquement si les deux appartiennent à la même personne**, dans les deux cas ci-dessous. Aucun transfert vers le compte d'une autre personne, même sur demande.
* **R42** · **Changement de pseudonyme** : le serveur conserve tout automatiquement, sauf les dollars ($), transférés par l'administration via un ticket précisant l'ancien et le nouveau pseudonyme.
* **R43** · **Compte perdu** : l'administration peut migrer vers ton nouveau compte, sur ticket, uniquement les éléments ci-dessous. Tout le reste est définitivement perdu.
...
* **R44** · **Utiliser la ferme d'un autre joueur** est <mark style="color:red;">**interdit**</mark>, sauf si tu en es contributeur ou membre du cercle proche du propriétaire, **et** qu'il t'y a autorisé. Ces deux conditions sont cumulatives : hors contributeurs et cercle proche, l'accès est interdit même si le propriétaire veut l'accorder.
* **R45** · **Construire tout ou partie d'une ferme en service pour un autre joueur** est <mark style="color:red;">**interdit**</mark> : job ou offre ouverte, hors de ton cercle, gratuit ou payé, technique ou non.
* **R46** · **L'Administration peut détruire une ferme** qui nuit à l'expérience de jeu des autres, si son propriétaire refuse les modifications demandées.
...
* **R48** · **Un PW doit se trouver à 10 chunks minimum de toute ferme, la tienne comprise**, pour qu'elle ne soit pas chargée par les visiteurs ; exception possible pour les fermes de taille modeste sans vocation de revente, à l'appréciation de la modération. En cas de conflit, l'antériorité prime : celui qui s'installe en second se met en conformité.
* **R49** · **Un PW doit être un point d'intérêt pour tous** : ne définis pas plusieurs PW autour d'une même zone quand un seul suffit, cela encombre la liste pour rien ; et ne t'en sers pas comme résidence supplémentaire. Les PW sans intérêt propre sont supprimés.
...
**Retaxonomie du 05/08** : les sections regroupent désormais les règles par nature (conduite envers les autres, règles des échanges, service boutique, garanties du serveur, fonctionnalités particulières) et non par thème apparent. Le Respect des joueurs remonte avant l'économie, l'arnaque rejoint les échanges, l'EnderDragon rejoint les fonctionnalités de l'End, les compensations rejoignent les transferts.

**Fournée anti-failles du 05/08** (décisions de l'Administration) : non-rétroactivité intégrée à R3, nouvelles règles R5 (impartialité, escalade Administration), R7 (mensonge à la modération), R26 (machines à lag), R28 (piégeage de joueurs), R30 (entités d'autrui), R36 (arnaque, interdite : décision de principe) ; R35 étendu à toute contrepartie extérieure dans les deux sens ; R32 protège les designs techniques non publics ; R50 redéfini par dragon (invocation → mort, dragon abandonné libre) ; R33 étendu à toute construction près d'autrui ; R48 antériorité ; R16 double plafond de publicité PW (par joueur et par PW, exploits documentés par ZelouiX) ; « contributeur » défini au lexique (ferme le contournement par contribution symbolique). Rejetés en connaissance de cause : l'engagement de l'équipe par la réponse d'un modérateur (un modérateur peut se tromper et être contredit ; la bonne foi s'apprécie via R3), l'obligation d'annoncer chaque modification (risque d'oubli), la réglementation de l'abus de vote (plafonné techniquement, indétectable).
...
| Warp dans une ferme + distance (ex 15-6, 15-7) | Une seule règle de distance, R48 (« toute ferme, la tienne comprise ») |
| Anti-doublons de PW (ex 15-9) | R49 énonce l'intention en clair : pas plusieurs PW quand un seul suffit |
...
| Décharge mineurs (ex 11-6) | Retirée : inopérante en droit (protection des mineurs d'ordre public) ; l'obligation d'autorisation reste (R39) |
...
| Accès aux fermes (ex 15-1, 15-2) | Conditions **cumulatives** en R44 : éligibilité (contributeur ou cercle proche) ET autorisation ; le propriétaire ne peut pas élargir |
...
| Schéma construction pour autrui (R45) | La question « technicité » disparaît (subjective, débat staff du 02/08) : une ferme ne se construit jamais en service pour autrui, technique ou non ; la collaboration dans le cercle reste libre. Philosophie retenue : on protège l'effort, pas le savoir |
...
| --- | --- | --- | --- |
| 0-1 | R1 | 11-2 | R37 |
| 0-2 | R3 | 11-3, 11-4 | R40 |
| 0-3 | R4 | 11-5 | R38 |
| 0-4, 0-6 | R6 | 11-6 | R39 |
| 0-5 | R8 | 11-7 | R35 |
| 1-1, 1-2, 1-3 (bis) | R9 | 11-8 | R41 |
| 1-3 | R10 | 11-9 | R42 |
| (foyer, non numéroté) | R11 | (compte perdu, nouveau) | R43 |
| 2-1, 2-2 | R19 | 13-1 | R29 |
| 3-1 | R12 | 13-2 | R31 |
| 3-2 | R13 | 13-3, 13-4 | R32 |
| 3-3 | R14 | 13-5 | R50 |
| 3-4 | R15 | 14 | R27 |
| 3-5, 3-6, 3-7 | R16 | 15-1, 15-2 | R44 |
| 3-8 | R8 | 15-3 | R45 |
| 3-9 | R17 | 15-4 | R46 |
| 3-10 | abrogée | 15-5 | R47 |
| (surveillance, nouveau) | R18 | 15-6, 15-7 | R48 |
| 4-1 | R20 | 15-8, 15-9 | R49 |
| 5-1 | R21 | 15-10 | R33 |
